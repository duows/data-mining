...
def main():
    ...
    # Criar o classificador SVM com GridSearch
    svm = SVC()
    ...
    # Melhor combinação de parâmetros encontrada pelo GridSearch
    print("Melhores parâmetros encontrados: ", grid_search.best_params_)
    print("Melhor pontuação de validação cruzada: {:.2f}%".format(grid_search.best_score_ * 100))

    # Prever usando o conjunto de dados de teste com o melhor estimador
